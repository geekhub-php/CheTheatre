 ...
 */
class Festival extends AbstractTranslateableStory
{
    use DeletedByTrait;
     ...
     * @ORM\JoinTable(name="festival_galleryHasMedia",
     *     joinColumns={@ORM\JoinColumn(name="festival_id",referencedColumnName="id")},
    ...
    /**
     * @param PerformanceEvent[] $performances
     */
