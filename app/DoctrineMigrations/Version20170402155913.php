...
class Version20170402155913 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        try{
            ...
            $this->addSql('
                SELECT @vs_id:=`vs`.`id` FROM `venue_sector` `vs` WHERE `vs`.`venue_id` = 1 AND `vs`.`slug` = "parterre";          
                ...
                SELECT @vs_id:=`vs`.`id` FROM `venue_sector` `vs` WHERE `vs`.`venue_id` = 1 AND `vs`.`slug` = "balcony";          
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                ...
                SELECT @vs_id:=`vs`.`id` FROM `venue_sector` `vs` WHERE `vs`.`venue_id` = 1 AND `vs`.`slug` = "loggia-left";          
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 1, gv, @vs_id FROM `autogenerated_values` LIMIT 10);

                SELECT @vs_id:=`vs`.`id` FROM `venue_sector` `vs` WHERE `vs`.`venue_id` = 1 AND `vs`.`slug` = "loggia-right";          
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 1, `gv`, @vs_id FROM `autogenerated_values` LIMIT 10);
            ');
    ...
    public function down(Schema $schema)
    {
        $this->addSql('
            SELECT @vs_id:=vs.id FROM `venue_sector` `vs` WHERE `vs`.`venue_id` = 1 AND `vs`.`slug` = "parterre";          
            DELETE FROM `seat` WHERE `venueSector_id` = @vs_id;  
            DELETE FROM `venue_sector` WHERE `id` = @vs_id;  
            SELECT @vs_id:=`vs`.`id` FROM `venue_sector` `vs` WHERE `vs`.`venue_id` = 1 AND `vs`.`slug` = "balcony";          
            DELETE FROM `seat` WHERE `venueSector_id` = @vs_id;  
            DELETE FROM `venue_sector` WHERE `id` = @vs_id;  
            SELECT @vs_id:=`vs`.`id` FROM `venue_sector` `vs` WHERE `vs`.`venue_id` = 1 AND `vs`.`slug` = "loggia-right";          
