    ...
    public function up(Schema $schema)
    {
        ...
        try{
            ...
            $this->addSql('
                ...
                SELECT @vs_id:=`vs`.`id` FROM `venue_sector` `vs` 
                WHERE `vs`.`venue_id` = @venue_kilic_house AND `vs`.`slug` = "parterre";    
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 1, `gv`, @vs_id FROM `autogenerated_values` LIMIT 17);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 2, `gv`, @vs_id FROM `autogenerated_values` LIMIT 19);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 3, `gv`, @vs_id FROM `autogenerated_values` LIMIT 20);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 4, `gv`, @vs_id FROM `autogenerated_values` LIMIT 20);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 5, `gv`, @vs_id FROM `autogenerated_values` LIMIT 20);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 6, gv, @vs_id FROM `autogenerated_values` LIMIT 20);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 7, `gv`, @vs_id FROM `autogenerated_values` LIMIT 20);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 8, `gv`, @vs_id FROM `autogenerated_values` LIMIT 20);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 9, `gv`, @vs_id FROM `autogenerated_values` LIMIT 20);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 10, `gv`, @vs_id FROM `autogenerated_values` LIMIT 20);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 11, `gv`, @vs_id FROM `autogenerated_values` LIMIT 18);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 12, `gv`, @vs_id FROM `autogenerated_values` LIMIT 17);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 13, gv, @vs_id FROM `autogenerated_values` LIMIT 17);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 14, gv, @vs_id FROM `autogenerated_values` LIMIT 17);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 15, `gv`, @vs_id FROM `autogenerated_values` LIMIT 17);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 16, `gv`, @vs_id FROM `autogenerated_values` LIMIT 17);
                INSERT INTO `seat` (`row`, `place`, `venueSector_id`) 
                (SELECT 17, `gv`, @vs_id FROM `autogenerated_values` LIMIT 20);
            ');
