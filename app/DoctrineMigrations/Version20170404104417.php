...
class Version20170404104417 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE performance_schedule ADD seriesNumber VARCHAR(10) DEFAULT NULL, ADD seriesDate DATETIME DEFAULT CURRENT_TIMESTAMP DEFAULT NULL, ADD enableSale TINYINT(1) DEFAULT \'0\'');
